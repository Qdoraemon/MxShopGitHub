    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_font_image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(auto_now=True, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父类别', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类别')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(auto_now=True, verbose_name='添加时间')),
                ('cagetory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='goods.GoodsCategory', verbose_name='商品类别的名称')),
            ],
            options={
                'verbose_name': '品牌的名称',
                'verbose_name_plural': '品牌的名称',
            },
        ),
        migrations.CreateModel(
            name='GoodsImage',
